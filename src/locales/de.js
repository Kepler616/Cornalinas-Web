  ...
  coleccion: {
    ...
    productos: {
      'origen-70': {
        ...
        formato: '70 g',
        descripcion: '70 g venezolanischer Kakao in seiner reinsten Form: intensiv, mit fruchtigen Noten und einem tief schokoladigen Nachklang, der bleibt.',
      },
      'leche-45': {
        nombre: 'Milchtafel (45 %)',
        formato: '70 g',
        descripcion: '70 g Zärtlichkeit in Schokolade gehüllt: cremig, mild, mit genau der richtigen Süße, die nach Zuhause schmeckt.',
      },
      'bombones-6': {
        nombre: 'Pralinenbox',
        formato: '6 Stück',
        descripcion: 'Sechs handgefertigte Pralinen, jede eine kleine Geschmacksgeschichte. Das perfekte Detail, um jemanden zu überraschen.',
      },
      'edicion-especial-9': {
        nombre: 'Sonderedition — Signature Box',
        formato: '9 Stück',
        descripcion: 'Unser ambitioniertestes Stück: neun Pralinen, die drei Texturen venezolanischen Kakaos in einer einzigen Box vereinen, zum Verschenken oder für dich selbst.',
      },
      'mini-pack-4': {
        nombre: 'Mini Pack',
        formato: '4 Tafeln · je 25 g',
        descripcion: 'Vier kleine Tafeln, perfekt zum Probieren, Teilen oder Mitnehmen, wohin du auch gehst: der Cornalinas-Geschmack im Taschenformat.',
      },
      'limon-coco': {
        nombre: 'Zitrone & Kokos',
        formato: 'Limitierte Edition · Kokosblütenzucker',
        descripcion: 'Dunkle Schokolade mit einer erfrischenden Zitronennote und einem Kokosherz, mit Kokosblütenzucker gesüßt für eine sanftere, natürlichere Süße.',
      },
    },
  },
  pedido: {
