  ...
  coleccion: {
    ...
    productos: {
      'origen-70': {
        ...
        formato: '70 g',
        descripcion: '70 g of Venezuelan cacao in its purest form: intense, with fruity notes and a deeply chocolatey finish that lingers.',
      },
      'leche-45': {
        nombre: 'Milk Bar (45%)',
        formato: '70 g',
        descripcion: '70 g of tenderness wrapped in chocolate: creamy, smooth, with just the right sweetness that tastes like home.',
      },
      'bombones-6': {
        nombre: 'Box of Bonbons',
        formato: '6 pieces',
        descripcion: 'Six handcrafted bonbons, each one a small story of flavor. The perfect detail to surprise someone.',
      },
      'edicion-especial-9': {
        nombre: 'Special Edition — Signature Box',
        formato: '9 pieces',
        descripcion: 'Our most ambitious piece: nine bonbons spanning three textures of Venezuelan cacao in a single box, to give or to keep for yourself.',
      },
      'mini-pack-4': {
        nombre: 'Mini Pack',
        formato: '4 bars · 25 g each',
        descripcion: 'Four small bars, perfect for sampling, sharing, or taking with you wherever you go: the Cornalinas taste in pocket size.',
      },
      'limon-coco': {
        nombre: 'Lemon & Coconut',
        formato: 'Special edition · Coconut sugar',
        descripcion: 'Dark chocolate with a citrusy hint of lemon and a coconut heart, sweetened with coconut sugar for a softer, more natural sweetness.',
      },
    },
  },
  pedido: {
